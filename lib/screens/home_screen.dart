...
class _MainHomeScreenState extends State<MainHomeScreen> {
  // Inisialisasi Instance Bluetooth & Variable State
  ...
  void _showPrinterDialog() {
    // Refresh daftar perangkat setiap dialog dibuka
    _initBluetooth();
            ...
            content: SizedBox(
              ...
              child: _devices.isEmpty
                  ? const Padding(
                      ...
                      child: Text('Tidak ada perangkat Bluetooth terpasang. Pastikan Bluetooth HP aktif & sudah di-pairing.', style: TextStyle(color: Colors.grey)),
                    )
                  : ListView.builder(
                      shrinkWrap: true,
        ...
        child: Column(
          ...
          children: [
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        _isConnected
                            ? 'Printer Terhubung: ${_selectedDevice?.name ?? "Bluetooth Thermal"}'
            ...
            _buildMenuItem(context, Icons.shopping_cart, 'Transaksi Penjualan (Kasir)', () {
              ...
              ).then((_) => _initBluetooth()); // Refresh status bluetooth setelah kembali
            }),
